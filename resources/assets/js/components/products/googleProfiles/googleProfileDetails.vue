<template>
    <div id="googleShoppingProfile">
        ...
        <div v-show="profile === null" id="googleShoppingProfile_noProfile">
            <p>No Google Shopping Profile was found for this product so please create one below</p>
        </div>
        <div>
            ...
            <div class="googleShoppingProfileSections">
                ...
                <tinymce v-model="googleProfile.attributes.description" :id="'profileDescription'"></tinymce>
            </div>
                        <div class="googleShoppingProfileSections">
                <label for="profileLabel2">Product Type</label>
                <input v-model="googleProfile.attributes.custom_label_0" id="profileLabel2" type="text"/>
            </div>
            <div class="googleShoppingProfileSections">
                <label for="profileLabel2">Google Product Category</label>
                <input v-model="googleProfile.attributes.custom_label_0" id="profileLabel2" type="text"/>
            </div>
            <div class="googleShoppingProfileSections">
                <label for="profileLabel2">Custom Label 0</label>
                <input v-model="googleProfile.attributes.custom_label_0" id="profileLabel2" type="text"/>
            </div>
            <div class="googleShoppingProfileSections">
            ...
            <div>
                ...
                <button v-show="profile != null" @click="deleteProfile()" class="btn btn-danger">Delete Profile</button>
            </div>
        </div>
    </div>
</template>
    ...
    export default {
        ...
        methods:{
            async saveProfile(){
                ...
                try{
                    var data = {
                        data: this.googleProfile
                    }
                    await googleProfileStore.createProfile(data);
                }catch(error){
                    console.log(error)
                }
            },
